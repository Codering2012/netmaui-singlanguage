...
def _init_multiprocessing_worker(backend: str, target_roi_size: int, hand_crop_size: int, pose_mode: str = "accurate-384"):
...
def main():
    ...
    if args.num_workers > 1:
        with mp.Pool(
            ...
            initargs=(args.backend, 256, 128, args.pose_mode),
        ) as pool:
        ...
        _init_multiprocessing_worker(args.backend, 256, 128, args.pose_mode)
