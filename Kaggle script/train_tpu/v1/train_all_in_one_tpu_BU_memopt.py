...
def _tpu_worker_fn(rank, args):
    ...
    if user_core_batch > 0:
        ...
        # On TPU: default to 256 per core (2048 total batch across 8 cores) to achieve ~2,000 seq/s
...
def build_parser():
    ...
    parser.add_argument(
        ...
        type=int,
        default=2048,
        help="Global physical batch size across all TPU cores / GPUs (Default: 2048 for 256 per core on 8-core TPU to sustain ~2,000 seq/s)",
    )
    parser.add_argument(
        "--per-core-batch",
        type=int,
        default=256,
        help="Explicit per-core micro-batch override (Default: 256 for TPU v5e systolic 128x128 MXU tile alignment and ~2,000 seq/s throughput; use 128 for 1024 total)",
    )
