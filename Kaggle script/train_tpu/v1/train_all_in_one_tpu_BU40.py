...
def get_dynamic_loader_len(
    loader: Any, default_steps: int = 400, args: Optional[Any] = None
) -> int:
    ...
    if ds is not None:
        if hasattr(ds, "total_records") and ds.total_records is not None and ds.total_records > 0:
            ...
            calc_len = max(1, ds.total_records // max(1, bs * world_sz))
...
def train_epoch_tpu(
    ...
    total_batches = get_dynamic_loader_len(loader, default_steps=400, args=args)
...
def validate_epoch_tpu(
    ...
    total_val_batches = get_dynamic_loader_len(loader, default_steps=default_val_limit, args=args)
...
def _tpu_worker_fn(rank, args):
    ...
    train_loader_len = get_dynamic_loader_len(train_loader, default_steps=400, args=args)
