...
class LandmarkAugmenter:
    ...
    def __call__(
        ...
        if np.random.rand() < finger_drop_prob:
            all_finger_groups = [
                list(range(19, 23)),  # LH Thumb
                list(range(23, 27)),  # LH Index
                list(range(27, 31)),  # LH Middle
                list(range(31, 35)),  # LH Ring
                list(range(35, 39)),  # LH Pinky
                list(range(40, 44)),  # RH Thumb
                list(range(44, 48)),  # RH Index
                list(range(48, 52)),  # RH Middle
                list(range(52, 56)),  # RH Ring
                list(range(56, 60)),  # RH Pinky
            ]
