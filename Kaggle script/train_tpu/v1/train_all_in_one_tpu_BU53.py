...
def _async_phase1_step_print(loss_cpu, acc_eng_cpu, acc_gloss_cpu, step_idx, step_fmt_str, lr_val, elapsed_val, samples_per_sec_val, steps_per_sec_val, ep, tot_ep, save_dir="."):
    try:
        if IS_TPU:
            import torch_xla.core.xla_model as xm
            if not xm.is_master_ordinal():
