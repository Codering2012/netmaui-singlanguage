...
class SignToGPT2Bridge(nn.Module):
    ...
    def forward(
        ...
        # For per-core batch >= 256 (h_flat >= 28672), use exactly 8 systolic tile-aligned chunks
        # (3,584 tokens each, exact multiple of 128) to cut backward transient memory by 2.52GB (saving 360MB).
        if IS_TPU:
