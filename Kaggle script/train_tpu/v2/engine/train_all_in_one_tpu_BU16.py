...
class SignToGPT2Bridge(nn.Module):
    ...
    def forward(
        ...
        # Static 128-token sequence length (16 prefix + 112 text tokens).
        # Perfectly aligns with TPU v5e / v3 128x128 systolic array tile (1 x 128).
        # Reduces GPT-2 lm_head logits from 2.88GB to 1.44GB and attention from 192MB to 48MB per layer.
        # Saves 4.60GB of HBM, allowing full native per-core batch 128 (accum_steps=1) to run inside 15.75GB.
