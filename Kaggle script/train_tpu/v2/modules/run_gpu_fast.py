...
def main():
    ...
    candidates = [
        Path(__file__).resolve().parent.parent / "engine" / "train_all_in_one_tpu.py",
        Path(__file__).resolve().parent / "train_all_in_one_tpu.py",
        Path(__file__).resolve().parent.parent / "train_all_in_one_tpu.py",
        Path("train_all_in_one_tpu.py").resolve(),
    ]
