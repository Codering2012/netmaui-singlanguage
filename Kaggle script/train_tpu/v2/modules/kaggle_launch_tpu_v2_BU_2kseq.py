...
def main():
    ...
    parser.add_argument("--batch-size", type=int, default=1024, help="Global batch size across 8 TPU cores (128 per core, accum_steps=1)")
    parser.add_argument("--per-core-batch", type=int, default=128, help="Per-core micro-batch size (128 for TPU v5e systolic tile alignment and ~208 steps/epoch)")
