...
class ASLVisualSaliencyCAM:
    ...
    def __init__(
        ...
        # Anatomical Index Definitions (60 Keypoints)
        self.face_indices = list(range(0, 11))
        self.left_hand_indices = list(range(11, 32))
        self.right_hand_indices = list(range(32, 53))
        self.body_indices = list(range(53, 60))
