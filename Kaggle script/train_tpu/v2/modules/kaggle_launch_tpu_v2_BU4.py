...
def main():
    ...
    parser.add_argument("--batch-size", type=int, default=128, help="Global batch size across 8 TPU cores (16 per core, accum_steps=1)")
    ...
    parser.add_argument("--max-steps", type=int, default=400, help="Max steps per training epoch (default: 400, strictly < 500)")
    parser.add_argument("--val-check-steps", type=int, default=50, help="Max steps per validation run (default: 50)")
    ...
    cmd = [
        ...
        "--val-check-steps", str(args.val_check_steps),
    ]
