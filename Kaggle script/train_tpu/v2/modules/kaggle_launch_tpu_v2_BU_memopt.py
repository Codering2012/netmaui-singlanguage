...
def main():
    ...
    parser.add_argument("--batch-size", type=int, default=2048, help="Global batch size across 8 TPU cores (256 per core, accum_steps=1, >=2,000 seq/s)")
    parser.add_argument("--per-core-batch", type=int, default=256, help="Per-core micro-batch size (256 for TPU v5e systolic tile alignment and ~104 steps/epoch)")
