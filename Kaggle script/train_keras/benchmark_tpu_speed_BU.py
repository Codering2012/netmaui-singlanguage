...
if __name__ == "__main__":
    ...
    if not is_tpu:
        print("[!] Local CPU environment detected: running lightweight mock benchmark.")
        benchmark_phase1(num_devices=num_devices, per_core_batch=2, warmup_steps=1, active_steps=2)
        benchmark_phase2(num_devices=num_devices, per_core_batch=2, warmup_steps=1, active_steps=2)
    elif num_devices == 1:
